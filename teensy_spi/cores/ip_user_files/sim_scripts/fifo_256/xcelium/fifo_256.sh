...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo_256 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo_256 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/danny/alchitry/teensy_spi/cores/managed_ip_project/managed_ip_project.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_256_sc.so .tmp_log xcelium_lib waves.shm c.obj)
