...
#
# Script generated by Vivado on Sat Feb 08 17:21:34 CET 2025
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_256.sh
...
#
# Usage        : fifo_256.sh
#                fifo_256.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_256.sh [-reset_run]
#                fifo_256.sh [-reset_log]
#                fifo_256.sh [-help]
#
...
#                script (type 'fifo_256.sh -help' for more information).
#
...
# script info
echo -e "fifo_256.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_256.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_256 xil_defaultlib.glbl -o fifo_256_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_256_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/danny/alchitry/teensy_spi/cores/managed_ip_project/managed_ip_project.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key fifo_256_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_256_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_256.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_256.sh [-help]\n\
Usage: fifo_256.sh [-step]\n\
Usage: fifo_256.sh [-lib_map_path]\n\
Usage: fifo_256.sh [-reset_run]\n\
Usage: fifo_256.sh [-reset_log]\n\
Usage: fifo_256.sh [-keep_index]\n\
Usage: fifo_256.sh [-noclean_files]\n\n\
